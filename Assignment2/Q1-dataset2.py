...
# Load .mat file
# For part a use 'data/points2D_Set2.mat'
...
plt.plot([point[0], line_point[0]], [point[1], line_point[1]], 'y-', label='Line 2')
line_point = point + principal_component2
plt.plot([point[0], line_point[0]], [point[1], line_point[1]], 'y-')
